...
public class SpleshActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
				...
				try {
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							Intent intent = new Intent(SpleshActivity.this,
		...
		String date1 = (new SimpleDateFormat("yyyy-MM-dd HH:mm")).format(date);
		...
		if (!isMyServiceRunning(PrivatisService.class)) {
			startService(new Intent(SpleshActivity.this, PrivatisService.class));
		}
	}
